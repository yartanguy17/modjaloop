...
<div class="container-fluid">
                           ...
                           <div class="row justify-content-between">
                              ...
                              <div class="col-sm-12 col-md-6">
                                 ...
                                 <a class="iq-bg-primary" href="#" data-toggle="modal" data-target="#add-user-view">
                                     ...
                                     <a class="iq-bg-primary" href="#" data-toggle="modal" data-target="#add-verification-view">
                                       Verifier compte
                                     </a>
      ...
      <div class="modal fade" id="add-user-view" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-header">
                <h5 class="modal-title">Nouveau Ledger</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{ route('app.ledger.save') }}" method="POST">

                <div class="row">
                <div class="col-6">
                            <div class="form-group">
                              <label>Dfsp</label>
                              <select name="dfsp_id" class="form-control">
                                 @foreach($dfsps as $dfsp)
                                    <option value="{{$dfsp->id}}">{{$dfsp->nom}}</option>
                                 @endforeach
                               </select>
                            </div>
                        </div>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label>Code</label>
                                <input type="text" class="form-control border-radius" value="{{ csrf_token() }}" readonly name="code">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
    ...
    <div class="modal fade" id="add-verification-view" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Vérifier Compte</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{ route('app.chequed.save') }}" method="POST">
